...
\usecasepost{le credenziali di accesso sono state verificate e l'utente è stato reindirizzato alla \emph{dashboard}}
...
\usecasepost{l'utente visualizza la pagina di segnalazione di risorsa non presente e decide se segnalare la mancanza o tornare alla \emph{dashboard}}
\label{uc:lista_progetti}
\end{usecase}
...
\hline
RFN-12.1 & L'utente deve poter filtrare le skill visualizzate per livello di competenza & - \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
RFN-12.2 & L'utente deve poter inserire una nuova skill nel sistema & - \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
RFD-2 & L'utente deve ricevere un feedback nell'interfaccia ogni volta che avvenga un errore di comunicazione col server & - \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
RFO-1 & Per tutti i dati presentati tramite lista va implementato l'infinite scroll & - \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
RFO-2 & L'utente deve poter visualizzare la quantità di progetti che richiedono registrazione tramite notifica nella dashboard & - \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
\end{tabularx}
\end{table}%
...
\hline
RVN-6.1 & L'interfaccia deve poter manipolare correttamente gli header \gls{http}\glsfirstoccur & - \\
\hline
