...
\usecasepre{l'utente non ha effettuato il login in \emph{SkillMatrix} e deve possedere credenziali valide}
...
\begin{usecase}{2}{Visualizzazione \emph{feedback} errore}
\usecaseactors{Utente non autenticato}
\usecasepre{l'utente non ha effettuato il login a \emph{SkillMatrix}}
...
\usecaseactors{Utente autenticato}
\usecasepre{l'utente deve aver eseguito con successo il login al sistema}
\usecasedesc{l'utente seleziona il menù di visualizzazione delle \emph{skill} registrate nel sistema}
...
\usecaseactors{Utente autenticato}
\usecasepre{l'utente deve aver effettuato il login presso \emph{SkillMatrix} ed avere una sessione attiva}
