...
La struttura base dell'applicativo SkillMatrix è un \gls{frontend} \gls{rest}. Un \gls{frontend} di quest tipo ha diversi vantaggi, uno tra tutti la modularità che si può ottenere da client a server.\\
